...
import 'package:halaapp/Pages/LogInPage/singUp.dart';
...
class AddLocation extends StatefulWidget {
  ...
  AddLocation({required this.WhichPage,super.key});
...
/*
//هذا الشرط يطبع اذا كان المستخدم داخل هذه الاحداثيات او لا ولكن تم تعطيله لطول التنفيذ ولكن في المستقبل سيتم تفعيله بحيث يتم تحديد المدينة للمستخدم تلقائياُ
    if (myPosition!.latitude <= Positionlat1 &&
        myPosition!.latitude <= Positionlat2 &&
        myPosition!.longitude >= Positionlat3 &&
        myPosition!.latitude >= Positionlat4) {
      print('تقع داخل المربع');
    } else {
      print('لا تقع داخل المربع');
    }*/
          ...
          Positioned(
            ...
            child: InkWell(
              onTap: (){
                ...
                showSnackBar(context: context, text: 'تم تحديد موقعك', color1: const Color.fromRGBO(2, 149, 193, 50));
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>
                SingUP(Lat: myPosition!.latitude, Long: myPosition!.longitude,LocationAdd: true,Dis:LocatianDetales.text,City: selectedTextIndex!),));
                }
              },
              child: Container(
