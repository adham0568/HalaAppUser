...
class popular extends StatefulWidget {
  int which;
  String Uid;
  popular({Key? key,required this.which,required this.Uid}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Container(
            margin: EdgeInsets.only(top: h/30,bottom: h/30),
            child: Text('المنتجات الأكثر طلباً',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: w/20),),
          ),
          FutureBuilder(
            future:
            FirebaseFirestore.instance
                .collection('Prudacts')
                .where('IdMarket', isEqualTo: widget.Uid)
